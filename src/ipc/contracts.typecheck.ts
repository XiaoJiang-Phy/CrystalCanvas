...
import type { GeneratedIpcArgs } from './commands.generated';
...
const pick_args: GeneratedIpcArgs<'pick_atom'> = { x: 0, y: 0, screenW: 800, screenH: 600 };
void pick_args;

// @ts-expect-error Rust `screen_h` maps to frontend `screenH`, never `screenHeight`.
const invalid_pick_args: GeneratedIpcArgs<'pick_atom'> = { x: 0, y: 0, screenW: 800, screenHeight: 600 };
